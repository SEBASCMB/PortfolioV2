import profilePic from '@/assets/sebastianProfile.webp'
      ...
      <div className="flex flex-wrap lg:flex-row-reverse">
        ...
        <div className='w-full lg:w-1/2'>
          <motion.div initial="hidden" animate="visible" variants={containerVariants} className='flex flex-col items-center lg:items-start mt-10'>
            <motion.h2 variants={childVariants} className='pb-2 text-4xl tracking-tighter lg:text-8xl'>Sebastian Marquez</motion.h2>
            ...
            <motion.a variants={childVariants} href='/resume.pdf' target='_blank' rel='noopener noreferrer' download className='bg-white rounded-full p-4 text-sm text-stone-800 mb-10'>Descargar CV</motion.a>
          </motion.div>
        </div>
      </div>
    </div >
